...
## Additional Features
- Updater (**NOTE**: You must upload your **token.pickle** to Index and fill your **token.pickle** url to **TOKEN_PICKLE_URL**, because your **token.pickle** will deleted after update, for more info please check [Setting up config file](https://github.com/Sh-Jil/mirror-bot/tree/master#setting-up-config-file))
...
- Clone this repo:
```
git clone https://github.com/Sh-Jil/mirror-bot mirrorbot/
cd mirrorbot
```
...
- **UPSTREAM_REPO**: Link for Bot Upstream Repo, if you want default update, fill `https://github.com/Sh-Jil/mirror-bot`.
...
- **DATABASE_URL**: Your Database URL. See [Generate Database](https://github.com/Sh-Jil/mirror-bot/tree/master#generate-database) to generate database (**NOTE**: If you use database you can save your sudo id permanent using `/addsudo` command).
...
- **USE_SERVICE_ACCOUNTS**: (Leave empty if unsure) Whether to use Service Accounts or not. For this to work see [Using Service Accounts](https://github.com/Sh-Jil/mirror-bot#generate-service-accounts-what-is-service-account) section below.
...
- Give stars and Fork this repo then upload **token.pickle** to your forks, or you can upload your **token.pickle** to your Index and put your **token.pickle** link to **TOKEN_PICKLE_URL** (**NOTE**: If you didn't upload **token.pickle** uploading will not work). How to generate **token.pickle**? [Read here](https://github.com/Sh-Jil/mirror-bot#getting-google-oauth-api-credential-file)
...
# Youtube-dl authentication using [.netrc](https://github.com/Sh-Jil/mirror-bot/blob/master/.netrc) file
...
And many more people who aren't mentioned here, but may be found in [Contributors](https://github.com/Sh-Jil/mirror-bot/graphs/contributors).
